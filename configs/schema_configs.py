...
# Default data root (inside project directory)
...
SCHEMA_CONFIGS = {
    ...
    "tsconfig": {
        ...
        "context_size": 2048,
        "default_epochs": 100,  # Base: tiny/mini/base ×1.5=150 epochs; small/medium/large =100 epochs
...
def get_schema_config(schema: str, data_root: Path = None) -> dict:
    ...
    Args:
        ...
        data_root: Optional data root directory (default: ./data)
